  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.cont_9_1
      .col-lg-8.mb-4.mb-lg-0(style="place-self:center;")
        p(data-aos="fade-up") En Colombia existen más de 700 plantas medicinales aprobadas para su uso y comercialización.
      ...
      .col-lg-4(style="place-self:center;")
        figure.col-7.m-auto.text-center
          img(src="@/assets/curso/tema9/1.png" data-aos="fade-left" style="display:inline;")
    ...
    .tarjeta.tarjeta--azul.p-5.mt-5(style="background-color:#E2EFFB;")
      SlyderA(tipo="b")
        .row
          ...
          .col-lg-5
            figure
              img(src="@/assets/curso/tema9/2.png")
        .row
          .col-lg-7.mb-4.mb-lg-0
          ...
          .col-lg-5
            figure
              img(src="@/assets/curso/tema9/3.png")
        .row
          .col-lg-7.mb-4.mb-lg-0
          ...
          .col-lg-5
            figure
              img(src="@/assets/curso/tema9/4.png")
        .row
          .col-lg-7.mb-4.mb-lg-0
